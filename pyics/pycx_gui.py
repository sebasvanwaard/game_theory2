...
from tkinter import (Tk, StringVar, Frame, Label, Button, Scale, Entry,
        Canvas, Scrollbar, Text, Checkbutton, BooleanVar, YES, NO, LEFT, RIGHT, BOTH, TOP, SUNKEN, X,
    ...
    def initGUI(self):
        ...
        for param in self.model.params:
            ...
            if isinstance(val, bool):
                ent = BooleanVar(value=val)
                field = Checkbutton(can, variable=ent, width=12)
            else:
                field = Entry(can, width=11)
                ent = field
